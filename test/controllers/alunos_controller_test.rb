...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { contato: @aluno.contato, data_de_nascimento: @aluno.data_de_nascimento, idade: @aluno.idade, nome: @aluno.nome } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { contato: @aluno.contato, data_de_nascimento: @aluno.data_de_nascimento, idade: @aluno.idade, nome: @aluno.nome } }
